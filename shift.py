...
def shift(img,vertical_shift=0,horizontal_shift=0):
    if vertical_shift>=0 and horizontal_shift>=0:
        return np.pad(img,((vertical_shift,0),(horizontal_shift,0),(0,0)))[:img.shape[0],:img.shape[1],:]
    elif vertical_shift<0 and horizontal_shift>=0:
        return np.pad(img,((0,-vertical_shift),(horizontal_shift,0),(0,0)))[-vertical_shift:,:img.shape[1],:]
    elif vertical_shift>=0 and horizontal_shift<0:
        return np.pad(img,((vertical_shift,0),(0,-horizontal_shift),(0,0)))[:img.shape[0],-horizontal_shift:,:]
    else:
